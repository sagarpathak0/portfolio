  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2"/>} description ="Once we agree on the plan, I turn on my lofi playlist and dive into coding, From initial sketches to polished code, I keep you updated every step of the way.">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development & Launch" icon={<AceternityIcon order="Phase 3"/>} description = "This is where magic happens! Based on the approved design, I'll translate everything into functional code, building your website from ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
